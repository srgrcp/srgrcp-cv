<template>
  <nuxt-link
    class="w-full h-52 md:max-w-xl md:h-72 overflow-hidden rounded-lg shadow-lg shadow-slate-900/50 flex justify-center items-center relative transition ease-in-out hover:scale-105 hover:rotate-2 m-4"
  ...
  >
    ...
    <div class="absolute bottom-0 left-0 w-full bg-slate-800/30 p-2 text-white">
