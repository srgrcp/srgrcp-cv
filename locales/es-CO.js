export default {
  appTitle: 'Hoja de Vida de Sergio Carrillo.',
  appDescription: 'Hoja de vida de Sergio Carrillo; Desarrollador full-stack, con experiencia en desarrollo de aplicaciones web, implementando tecnologías como Angular, React, Vue, Go, Nodejs, entre otros.',
  ...
  workExperience: [
    ...
    },
    {
      ...
      time: 'Diciembre 2020 - Marzo 2021 (4 meses)',
      description: 'Desarrollo de servicios web GraphQL para el consumo de diversos proyectos frontend y móvil, a disposición de una plataforma de servicios médicos.',
      stack: [
        'Go',
        'GraphQL',
        'Gorm',
